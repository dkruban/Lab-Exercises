...
def main():
    ...
    if total_samples > 150:
        print(f"\nRandomly selecting 150 samples from {total_samples} total samples...")
        indices = random.sample(range(total_samples), 150)
    ...
    # Print distances in original order
    ...
    # Sort neighbor details by rank for display
